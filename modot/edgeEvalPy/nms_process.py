...
# from edgeEvalPy.impl.toolbox import conv_tri, grad2
from ctypes import *
...
solver = cdll.LoadLibrary("./newcrfs/edgeEvalPy/cxx/lib/solve_csa.so")
...
if __name__ == '__main__':
    img_original_projection = "../00002/00002_ob.png"
    image2 = cv2.imread(img_original_projection, cv2.IMREAD_UNCHANGED)
    image2 = (255 - np.array(image2)) / 255
    nms_process_one_image(image2, "../pynms.png")
